...
import { Text, Header, Arabica, Robusta, Wrapper } from './TypesOfBeans.styled';
const TypesOfBeans = () => {
  return (
    <Wrapper>
      <Arabica />
      ...
      <Text>
        Pochodzi ona głównie z Afryki i Indonezji. Smak jest bardzo intensywny,
        ostry ,ziemisty, oraz odznacza się lekką goryczą. Najważniejszą cechą
        Robusty, jest wysoka zawartość kofeiny w każdym ziarnie nawet do 2.5%.
        Jest to idealna propozycja dla osób, które potrzebują mocnego pobudzenia
        o poranku.
      </Text>
    </Wrapper>
  );
